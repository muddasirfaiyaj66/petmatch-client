...
const [count,setCount]= useState(0)
  ...
  const { data:campaignData, isLoading ,refetch} = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosSecure.get(`/donations?page=${currentPage}&limit=10`);
      return res.data;
    }
  });
...
return (
    <div className="App">
      ...
      <h1 className="uppercase text-center text-5xl mb-10 font-bold text-transparent bg-clip-text bg-gradient-to-r to-[#0000FF] from-[#00ff9d]">All Donations</h1>
      </div>
