...
const  EditMyDonationCampaign = () => {
    ...
    const {data:previousData}=useQuery({
        queryKey:['myDonationPreviousData', id],
        queryFn: async()=>{
    ...
    const {name, lastDate,lastTime,short_description,long_description, maxDonationAmount,}=previousData || {};
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values,  {resetForm}) => {
       ...
       const petData = await  axiosSecure.put('/donationCampaigns', formData)
          ...
          <div className="my-10 mb-20">
            <div className="max-w-screen-xl mx-auto bg-[#F4F3F0] p-10 rounded-xl shadow-lg">
              <div className="text-center space-y-8">
                <h1 className="md:text-5xl text-2xl my-5 font-bold">Update {name} Donation Campaign</h1>
              </div>
